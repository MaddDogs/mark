  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    ...
	    {title: `🗿🚬 Sc Ini Direcode Oleh KhrlMstfa `, rowId: "p", description: "Follow Ig Markbot"},
...
let tek = `
 ...
 │*Sc Ini Direcode Oleh GaaraOfc.*
 │*Follow Juga Ig: https://instagram.com/gaara_xploite*
 ╰─────────────⬣
`
const listMessage = {
  text: tek,
