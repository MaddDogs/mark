 ...
 *Jawaban:* ${pickRandom(['Ya','Mungkin iya','Mungkin','Mungkin tidak','Tidak','Tidak mungkin'])} 
 ...
 handler.help = ['ɴᴜʀᴜᴛᴏᴍᴏ','ᴀᴅɪᴡᴀᴊsʜɪɴɢ','ʀᴇɴᴅʏᴄʀᴀғᴛ','ɪʙɴᴜ ɴʀ','ʙᴀᴋᴀ ʙᴏᴛᴢ', 'ᴀʀɪғғʙ25','ᴀᴛᴇɴᴀʙᴏᴛ','ʙᴀᴋᴀ ᴛᴇᴀᴍ','ꜰᴀɴɢᴢxᴅ','ꜰᴏᴋᴜꜱ ɪᴅ','ᴋᴀɴɴᴀ','ᴛʜᴇ.ꜱᴀᴅ.ʙᴏʏ01','ᴀᴍɪʀᴜʟ','ɴᴜʀᴜᴛᴏᴍᴏ','ʙᴏᴄʜɪʟɢᴀᴍɪɴɢ','Gaara'] 
 handler.tags = ['thnks'] 
